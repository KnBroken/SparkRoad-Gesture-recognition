...
//			  txbuf[0]=Roll_High8;
//				txbuf[1]=Roll_Low8;		
//				txbuf[2]=Roll_decimal;
//				txbuf[3]=GZ_High8;
//				txbuf[4]=GZ_Low8;
//				txbuf[5]=Encoder_A_High8;
//				txbuf[6]=Encoder_A_Low8;	
//			  txbuf[7]=0;	
//				CAN1_Send_Num(0x101,txbuf);	 //标识符1，用于区分两组数据					
//				}
//	else//第二次
//				{	
//        txbuf[0]=Encoder_B_High8;  
//				txbuf[1]=Encoder_B_Low8; 
//				txbuf[2]=Encoder_C_High8;  
//				txbuf[3]=Encoder_C_Low8;
//				txbuf[4]=Encoder_D_High8;
//				txbuf[5]=Encoder_D_Low8;
//				txbuf[6]=Encoder_Direction;	
//				txbuf[7]=0;			
//      	CAN1_Send_Num(0x100,txbuf);	//标识符2，用于区分两组数据				
//	      }
//}
