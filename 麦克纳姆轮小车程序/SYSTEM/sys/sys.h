...
extern u8 Run_Flag,PID_Send,Flash_Send,Turn_Flag,Flag_Way,Flag_Next;
extern u8 rxbuf[8],Urxbuf[8],t2xbuf[129],t3xbuf[21],SENT[17],CAN_ON_Flag,Usart_ON_Flag1,Usart_ON_Flag3,PS2_ON_Flag,Remote_ON_Flag,Usart_Flag,APP_ON_Flag,Usart_Flag,PID_Send,Flash_Send;  //CAN和串口控制相关变量
extern u8 txbuf[8],txbuf2[8],Turn_Flag;             //CAN发送相关变量
