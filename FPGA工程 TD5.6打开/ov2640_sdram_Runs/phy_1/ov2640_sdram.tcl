...
set rc [catch {
  ...
  import_db {../syn_1/ov2640_sdram_gate.db}
  read_sdc
  place
  export_db {ov2640_sdram_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file ov2640_sdram_phy.area
  export_db {ov2640_sdram_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid ov2640_sdram_inst.bid
  bitgen -bit "ov2640_sdram.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
